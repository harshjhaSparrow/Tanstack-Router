...
import { Route as userUserIndexImport } from './routes/(user)/user/index'
import { Route as organizationsFolderPostsPostsIndexImport } from './routes/(organizationsFolderPosts)/posts.index'
import { Route as userUserUserIdImport } from './routes/(user)/user/$userId'
import { Route as organizationsFolderPostsPostsPostIdImport } from './routes/(organizationsFolderPosts)/posts.$postId'
import { Route as userUserUseridEditImport } from './routes/(user)/user.$userid.edit'
...
const LayoutFurtherRoute = LayoutFurtherImport.update({
  path: '/further',
  getParentRoute: () => LayoutRoute,
} as any)

const LayoutChildOfLayout2Route = LayoutChildOfLayout2Import.update({
  path: '/ChildOfLayout2',
  getParentRoute: () => LayoutRoute,
} as any)
...
const userUserIndexRoute = userUserIndexImport.update({
  path: '/user/',
  getParentRoute: () => rootRoute,
} as any)

const organizationsFolderPostsPostsIndexRoute =
  organizationsFolderPostsPostsIndexImport.update({
    path: '/posts/',
    getParentRoute: () => rootRoute,
  } as any)
...
const organizationsFolderPostsPostsPostIdRoute =
  organizationsFolderPostsPostsPostIdImport.update({
    path: '/posts/$postId',
    getParentRoute: () => rootRoute,
  } as any)

const userUserUseridEditRoute = userUserUseridEditImport.update({
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_layout/ChildOfLayout2': {
      id: '/_layout/ChildOfLayout2'
      path: '/ChildOfLayout2'
      fullPath: '/ChildOfLayout2'
      preLoaderRoute: typeof LayoutChildOfLayout2Import
      parentRoute: typeof LayoutImport
    }
    '/_layout/further': {
      id: '/_layout/further'
    ...
    '/(organizationsFolderPosts)/posts/$postId': {
      id: '/posts/$postId'
      path: '/posts/$postId'
      fullPath: '/posts/$postId'
      preLoaderRoute: typeof organizationsFolderPostsPostsPostIdImport
      parentRoute: typeof rootRoute
    }
    '/(user)/user/$userId': {
      id: '/user/$userId'
    ...
    '/(organizationsFolderPosts)/posts/': {
      id: '/posts/'
      path: '/posts'
      fullPath: '/posts'
      preLoaderRoute: typeof organizationsFolderPostsPostsIndexImport
      parentRoute: typeof rootRoute
    }
    '/(user)/user/': {
      id: '/user/'
      path: '/user'
      fullPath: '/user'
      preLoaderRoute: typeof userUserIndexImport
      parentRoute: typeof rootRoute
    }
    '/(user)/user/$userid/edit': {
      id: '/user/$userid/edit'
      path: '/user/$userid/edit'
      fullPath: '/user/$userid/edit'
      preLoaderRoute: typeof userUserUseridEditImport
      parentRoute: typeof rootRoute
    }
  }
}
...
export const routeTree = rootRoute.addChildren({
  ...
  SettingsIndexRoute,
  homeIndexLazyRoute,
  organizationsFolderPostsPostsPostIdRoute,
  userUserUserIdRoute,
  organizationsFolderPostsPostsIndexRoute,
  userUserIndexRoute,
  userUserUseridEditRoute,
})
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/_layout/ChildOfLayout2": {
      "filePath": "_layout/ChildOfLayout2.tsx",
      "parent": "/_layout"
    },
    "/_layout/further": {
    ...
    "/posts/$postId": {
      "filePath": "(organizationsFolderPosts)/posts.$postId.tsx"
    },
    "/user/$userId": {
      "filePath": "(user)/user/$userId.tsx"
    },
    "/posts/": {
      "filePath": "(organizationsFolderPosts)/posts.index.tsx"
    },
    "/user/": {
      "filePath": "(user)/user/index.tsx"
    },
    "/user/$userid/edit": {
      "filePath": "(user)/user.$userid.edit.tsx"
    }
  }
}
ROUTE_MANIFEST_END */
